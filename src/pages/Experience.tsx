...
const experienceData: ExperienceProps[] = [
  {
    ...
    description: [
      "Designed and developed a fee reconciliation application for the Accounts team using Python, Flask, and AdminLTE, enabling accurate tallying of high-volume fund transactions. Led the full lifecycle - requirement gathering, SRS documentation, backend architecture, feature implementation, testing, and demos - completing ~60% of the system and delivering a scalable foundation that reduced manual reconciliation effort significantly.",
