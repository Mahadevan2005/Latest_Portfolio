...
const highlights = [
  { icon: <FaCode />, title: "1560+ Problems Solved", subtitle: "Across LeetCode, CodeChef, and other platforms." },
  ...
  { icon: <FaCodeBranch />, title: "970+ Contributions", subtitle: "Consistent coding streak & contributions." },
