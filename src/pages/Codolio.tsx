...
const highlights = [
  { icon: <FaCode />, title: "1550+ Problems Solved", subtitle: "Across LeetCode, CodeChef, and other platforms." },
  ...
  { icon: <FaAward />, title: "30 Awards & Badges", subtitle: "Including LeetCode 365 Days, CodeStudio Specialist Badges." },
  { icon: <FaCodeBranch />, title: "965+ Contributions", subtitle: "Consistent coding streak & contributions." },
...
const Codolio = () => {
  ...
  return ( 
    <section
      className="relative min-h-screen bg-gradient-to-b from-white via-amber-50/30 to-cyan-50/30 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 py-12 sm:py-16 overflow-hidden"
    >
