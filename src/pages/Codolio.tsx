...
const highlights = [
  { icon: <FaCode />, title: "1590+ Problems Solved", subtitle: "Across LeetCode, CodeChef, and other platforms." },
  ...
  { icon: <FaCodeBranch />, title: "980+ Contributions", subtitle: "Consistent coding streak & contributions." },
