...
const highlights = [
  { icon: <FaCode />, title: "1440+ Problems Solved", subtitle: "Across LeetCode, CodeChef, and other platforms." },
  ...
  { icon: <FaCodeBranch />, title: "850+ Commits", subtitle: "Consistent coding streak & contributions." },
